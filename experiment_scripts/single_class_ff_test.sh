...
python experiment_scripts/adv_attack_resnet.py --data_root $ff_root_path --checkpoint_path $ff_ckpt_path --attack_name l2gauss \
 --single_class_string 2 --out_file ${out_path}/ff_2_l2gauss.txt