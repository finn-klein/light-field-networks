...
python $script_path/gradient_attack_resnet.py --data_root $ff_root_path --single_class_string 0 --out_file $WORK/experiments/grad_resnet_test/test.txt --checkpoint_path $ff_ckpt_path
