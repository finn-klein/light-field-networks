...
python $script_path/gradient_attack_resnet.py --data_root $ff_root_path --attack_name $attack --single_class_string $class --out_file $WORK/experiments/grad_resnet_test/test.txt --checkpoint_path $ff_ckpt_path
